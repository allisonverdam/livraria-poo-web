...
<hr>
	<form action="salvarUsuario" method="post" onsubmit="return validar()" class="form-group">
...
<label for="senha">Senha:</label>
<input type="password" id="senhaConf" name="senhaConf" class="input" required>
<input type="submit" value="Enviar" class="btn btn-vermelho">
</form>
	<a href="abrirLogin" class="btn btn-cinza" style="text-decoration: none;">Logar</a>
	</div>
	</div>
</body>
</html>
